DECLARE cutoff_date DATE DEFAULT '2025-10-01'; -- We pretend this is "Today"
DECLARE prediction_window_days INT64 DEFAULT 30; -- We want to predict churn in this window
...
future_purchases AS (
  ...
  WHERE DATE(created_at) BETWEEN cutoff_date AND DATE_ADD(cutoff_date, INTERVAL prediction_window_days DAY)
)
